...
class VitRGBD(LightningModule):
    ...
    def forward(self, x: torch.Tensor):
        # TODO implement forward pass for rgb and depth
    ...
    def model_step(self, batch_src: Any):
        ...
        # TODO: implement model step for rgb and depth
